...
searchBar.addEventListener('keyup', () => {
  ...
  for (let i=0; i<userNames.length; i++) {
    const txtValue = userNames[i].innerText.toUpperCase();
...
const mainBlocks = document.querySelectorAll('.m-block');
const msgSent = document.getElementById('msg-confirmation');

const rtnBtn = document.getElementById('rtn-btn');
